#ASSIGNMENT 1
#NAME- Saket Priyadarshi, SID- 21107084
# QUESTION 1
print("\nAnswer for ques1:")
...
print ("\ntax on your income is:",tax)

############################################################################################################################
# QUESTION 3
print("\nAnswer for ques3:")
number_of_minutes=int(input("/nEnter number of seconds : "))                       #takes number of minutes as input from user
